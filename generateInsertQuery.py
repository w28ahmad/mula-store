...
with open(WRITEFILE, 'w') as f:
    ...
    for question in data['questions']:
        ...
        f.write(f"INSERT INTO question_solutions (id, correct_solution, diagram, explanation, question_id) VALUES({count}, {solutionData['solution']}, {solutionData['diagram']}, {solutionData['explanation']}, {count});\n")
        f.write(f"INSERT INTO question_details (id, grade, part_type, part_number, part_size, subject, topic, question_id) VALUES({count}, {details['grade']}, {details['partType']}, {details['partNumber']}, {details['partSize']}, {details['subject']}, {details['topic']}, {count});\n")
